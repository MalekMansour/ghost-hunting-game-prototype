...
Scissors
Trash Bag (smell)
Rotten Food (smell, food)
Canned Food (food)
Plushy
UV Flashlight

Kid’s Pizza Place Items:
Plate
Fork
Spoon
Knife
...
UPGRADES: 
Can only equip 3 upgrades at a time.
Cannot equip more of the same upgrade category (example: cannot have 2 camera upgrades at the same time)
...
Longer distance light (2X)

Sanity Upgrades:
Slow Drainer I: Sanity drains 10% slower
Slow Drainer II: Sanity drains 25% slower
Slow Drainer III: Sanity drains 50% slower
Shock Resistance I: Ghost attacks reduces sanity drain by 25%
Shock Resistance II: Ghost attacks reduces sanity drain by 50%
Shock Resistance III: Ghost attacks reduces sanity drain by 75%.

Inventory Upgrades:
+1 Inventory slot

Speed Upgrades:
Speed I: Make the player 10% faster when sprinting 
Speed II: Make the player 25% faster when sprinting
Speed III: Make the player 40% faster when sprinting

Stamina Upgrades:
BY DEFAULT ITS 6
Stamina I: Makes the player stamina lasts 8 seconds
Stamina II: Makes the player stamina lasts 10 seconds
Stamina III: Makes the player stamina lasts 12 seconds

TODO LIST AFTER STEAM PAGE CREATION:
Make the steam page look good
Have a good trailer
Enter Steam Festivals
Post it on reddit
Post it on twitter
Post it on instagram
Post it on discord
Give 100 youtubers/streamers steam keys to the game
...
February Beta 0.2:
10 Ghosts
1 New Map: Kid’s Pizza Palace
4 Characters 
4 Ghost Models

March Beta 0.3: 
12 Ghosts
1 New Map: Aquatic Center Pool
4 Characters 
6 Ghost Models
